...
Version:    1.0.0: Initial Version
            ...
            3.0.1: small fix to just get dates from today
            3.0.2: fix for xmas tree collection 

<plugin key="BsrWasteCollection"
name="BSR - Berlin Waste Collection" author="belze"
version="3.0.2" wikilink="" externallink="https://github.com/belzetrigger/domoticz-BSR" >
    <description>
